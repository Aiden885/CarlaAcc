...
fprintf('\n🎉 查找表生成完成！\n');
fprintf('\n下一步:\n');
fprintf('1. 在Simulink中创建模型 acc_decision_core.slx\n');
fprintf('2. 添加 Lookup Table (2-D) 模块\n');
fprintf('3. 在模块参数中加载 decision_lookup_data.mat\n');
fprintf('4. 设置 Breakpoints: state_bp, command_bp\n');
fprintf('5. 设置 Table data: next_state_table (或其他表)\n\n');

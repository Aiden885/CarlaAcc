...
#define S_FUNCTION_NAME sppvt_control_model_msf
#endif
...
false ) ; ssSetInputPortSampleTime ( S , 7 , 0.05 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 8 , 0.05 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 9 , 0.05 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 10 , 0.05 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 11 , 0.05 ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 2 , 0.05 ) ; ssSetOutputPortOffsetTime ( S
...
#endif
} ssSetOutputPortSampleTime ( S , 3 , 0.05 ) ; ssSetOutputPortOffsetTime ( S
...
#endif
} ssSetOutputPortSampleTime ( S , 4 , 0.05 ) ; ssSetOutputPortOffsetTime ( S
...
mr_sppvt_control_model_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S
...
mr_sppvt_control_model_MdlInfoRegFcn ( S , "sppvt_control_model" , & retVal )
; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( honz4qowvac ) ) )
...
mdlInitializeSampleTimes ( SimStruct * S ) { ssSetSampleTime ( S , 0 , 0.05 )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { honz4qowvac * dw = ( honz4qowvac * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } moodhcvwbn ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , true ) , & ( dw -> rtm ) , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { honz4qowvac * dw = ( honz4qowvac * ) ssGetDWork ( S , 0 )
; real_T const * i_hdli10rw41 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
real_T const * i_msuwzzdm4m = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
real_T const * i_ilzcdnggvi = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
real_T const * i_jgnpomzdhw = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ;
real_T const * i_luglm41c0i = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ;
real_T const * i_ks51yerxbk = ( real_T * ) ssGetInputPortSignal ( S , 7 ) ;
real_T const * i_bbjtvvojti = ( real_T * ) ssGetInputPortSignal ( S , 8 ) ;
real_T const * i_n3mj3m1w41 = ( real_T * ) ssGetInputPortSignal ( S , 9 ) ;
real_T const * i_fz35tujmj4 = ( real_T * ) ssGetInputPortSignal ( S , 10 ) ;
real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T *
o_B_1_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_1_4 = ( real_T * ) ssGetOutputPortSignal ( S , 3 ) ; boolean_T * o_B_1_5 = ( boolean_T * ) ssGetOutputPortSignal ( S , 4 ) ; if ( tid == PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { sppvt_control_model ( i_hdli10rw41 , i_msuwzzdm4m , i_ilzcdnggvi , i_jgnpomzdhw , i_luglm41c0i , i_ks51yerxbk , i_bbjtvvojti , i_n3mj3m1w41 , i_fz35tujmj4 , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 ) ; } } static void mdlTerminate ( SimStruct * S ) { honz4qowvac * dw = ( honz4qowvac * ) ssGetDWork ( S , 0 ) ; i24dvpsv4q ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_sppvt_control_model_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_sppvt_control_model_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
mr_sppvt_control_model_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss

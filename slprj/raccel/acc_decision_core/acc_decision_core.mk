...
MAKECMD         = /home/aiden/snap/code/app/matlab/bin/glnxa64/gmake -j 1 -l 1
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = acc_decision_core
MODULES                 = acc_decision_core.c acc_decision_core_capi.c acc_decision_core_data.c acc_decision_core_tgtconn.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = acc_decision_core
MAKEFILE                = acc_decision_core.mk
MATLAB_ROOT             = /home/aiden/snap/code/app/matlab
ALT_MATLAB_ROOT         = /home/aiden/snap/code/app/matlab
START_DIR               = /home/aiden/PycharmProjects/CarlaAcc
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = GLNXA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/home/aiden/snap/code/app/matlab" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DUSE_LOCALHOST -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADDITIONAL_LDFLAGS      =  -Wl,--allow-shlib-undefined -Wl,-rpath,/home/aiden/snap/code/app/matlab/sys/os/glnxa64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/acc_decision_core \

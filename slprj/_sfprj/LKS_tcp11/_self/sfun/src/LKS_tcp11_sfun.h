#ifndef __LKS_tcp11_sfun_h__
#define __LKS_tcp11_sfun_h__
...
extern mxArray* load_LKS_tcp11_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_LKS_tcp11_optimization_info(void);

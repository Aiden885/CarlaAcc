...
class DisplayManager:
    ...
    def _render_info_overlay(self, info):
        ...
        info_texts = [
            ...
            ("Control", "ACC" if info.get('acc_active', False) else "Manual",
             (0, 255, 0) if info.get('acc_active', False) else (255, 255, 255)),
            ("", "", (255, 255, 255)),
            ...
            ("", "", (255, 255, 255)),
            ("V3 (Max)", f"{info.get('V3_kmh', 0):.1f} km/h", (255, 255, 255)),
